...
public class Course {
    ...
    public Course(int courseID, String courseTitle, String courseDivide,String courseGrade,  int coursePersonnel, int courseRival) {
        this.courseID = courseID;
        this.courseTitle = courseTitle;
        this.courseDivide = courseDivide;
        this.courseGrade = courseGrade;
    ...
    public Course(int courseID, String courseTitle, String courseDivide,String courseGrade,  int coursePersonnel, int courseRival, int courseCredit) {
        this.courseID = courseID;
        this.courseTitle = courseTitle;
        this.courseDivide = courseDivide;
        this.courseGrade = courseGrade;
    ...
    public Course(int courseID, String courseGrade, String courseTitle, int courseCredit, String courseDivide, int coursePersonnel, String courseProfessor, String courseTime) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseCredit = courseCredit;
